  ...
  return (
    <div>
      <div className="lg:flex">
        <div className="lg:w-1/2 lg:pl-[8rem] pt-[5rem] lg:pb-[4rem]">
          ...
          <img className="xs:hidden" src={HelpImage} />
        </div>
        <div className="lg:w-1/2">
          {/* Text 1 */}
          <div className="flex mb-[1rem] lg:mt-[5rem] xs:ml-[1rem] lg:ml-[4rem]">
          ...
          <p className="text-[18px] xs:ml-[5rem] xs:mr-[3rem] lg:ml-[8rem]">
            Reach out and let us know about your trees. Feel <br /> free to send
            pictures.
          </p>
          {/* Text 2 */}
          <div className="flex mb-[1rem] mt-[2rem] xs:ml-[1rem] lg:ml-[4rem]">
            <img className="h-[40px] mt-[5px] mr-[1rem]" src={EllipseCircle} />
            <img
              className="h-[10px] relative top-[19px] left-[-38px]"
              src={No2}
          ...
          <button className="flex bg-[#FF740A] text-[white] text-[18px] xs:ml-[1.3rem] lg:ml-[8rem] mt-[4rem] mb-[2rem] py-2 xs:px-[2rem] lg:px-12 rounded-md">
            <img className="mr-[0.6rem]" src={MessageText} />
            Schedule your Free Evaluation Today
          </button>
          <img
            className="lg:hidden xs:px-4 xs:pt-[1rem] xs:pb-[4rem]"
            src={HelpImage}
          />
        </div>
      </div>
